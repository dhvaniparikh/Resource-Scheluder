...
<?php
    ...
    if(isset($_POST["btnsubmit"]))
    {
        ...
        if($x==$otp)
        {
            header("location:reset-pass3.php");
        }
        else
			{
                        ...
                        <div class="px-2">
                            <form action="" method="post" class="justify-content-center">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter otp" name="txtotp" required>
                                </div>
                                
                                <button type="submit" class="btn btn-primary btn-lg" name="btnsubmit">Confirm OTP</button>

								...
								<div>
									<div id="user-profile-1" class="user-profile row">
									 ...
									 <?php
										...
										$qry2="select project.pid as pid,fname,lname,userimg,user.userid as userid from proj_employee,user,project where proj_employee.userid=user.userid and proj_employee.pid=project.pid and project.pid='$id' and job_status='working'";
										...
										while($row2=$result->fetch_assoc())
										{
											...
											<td>".$row2["lname"]."</td><td><a href='task_form.php?id=$pid&uid=$userid'>Assign Task</td></tr>";
										}
										$table.="</table>";
										echo $table;
									?>
